...
PACKAGE = "django_select2_chained"
...
if len(sys.argv) > 1 and 'sdist' == sys.argv[1]:
    minify(['static/js/select2_chained.js'], 'static/js/select2_chained.min.js', 'js')
...
setup(
    ...
    dependency_links=[
        "https://github.com/djkartsa/django-select2/tarball/4.2.2-fix_for_inline_formsets#egg=django-select2-4.2.2b0"
    ],
    install_requires=[
        "Django>=1.3,<1.6",
        "django-select2==4.2.2b0"
    ],
)
